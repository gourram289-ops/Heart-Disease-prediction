...
st.markdown(
    ...
    <style>
        ...
        [data-theme="light"] .metric-caption,
        [data-theme="light"] .small-note,
        ...
        [data-theme="light"] .matrix .diag {
            background: #e8f7ef;
            border-color: #c5ead5;
        }

        [data-theme="light"] .matrix .offdiag {
            background: #fff0f1;
            border-color: #f4d1d5;
        }

        [data-theme="light"] .result-positive {
            background: linear-gradient(135deg, #fff1f2, #fffafb);
            border-color: #f2cbd1;
        }

        [data-theme="light"] .result-negative {
        ...
        [data-theme="light"] .result-positive .result-title {
            color: #9b2637;
        }

        [data-theme="light"] .result-negative .result-title {
            color: #167044;
        }

        [data-theme="light"] div[data-baseweb="input"] > div,
        ...
        [data-theme="light"] div[data-baseweb="select"] [role="combobox"] {
            color: #172b4d !important;
        ...
        [data-theme="light"] .stApp label p,
        ...
        [data-theme="light"] [data-testid="stFormSubmitButton"] button[kind="primary"] {
            border-color: #2563eb !important;
            background: linear-gradient(135deg, #2563eb, #0e7490) !important;
            color: #ffffff !important;
        }

        /* Streamlit widget labels inherit its theme text color. Give them
           explicit contrast against the app's custom dark panels. */
